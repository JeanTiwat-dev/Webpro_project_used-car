          ...
          >
            ...
            "
                ...
                "
                    ...
                    <div
                      v-if="$v.car_regis.$error"
                      class="text-xs text-red-700 mt-2"
                    >
                      <p v-if="!$v.car_regis.required">
...
export default {
  ...
  methods: {
    addpic(event) {
      ...
      this.boxupimg = this.images.length;
    ...
    updateProduct() {
      ...
      if (this.$v.$invalid) {
        ...
        if (this.images.length != 6) {
          ...
          axios
            .put(
              `http://localhost:3000/editCar/${this.$route.params.carId}`,
              formData
            )
            .then(_res => {
    ...
    getCar() {
      axios
        ...
        .then(res => {
          ...
          if (
            this.car.seller_id != this.user.user_id &&
...
//TODO format date (editcar, editprofile) p //TODO currentcy p //TODO validate
ให้แก้รถได้แค่ id ตัวเอง p //TODO create button editcar //TODO validate
editpassword p //TODO reset button sort & filter (focus)
