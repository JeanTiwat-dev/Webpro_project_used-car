<template>
  <div id="app">
    <!-- component -->
    <div class="py-12 flex items-center justify-center bg-gray-100 pb-18 pt-28">
      <div class="flex">
        <!-- left card -->
        <div>
          <div
          ...
          >
            ...
            >
              <a
                href="#"
                class="bg-red-500 hover:bg-red-700 text-white text-center py-2 px-4 rounded-full h-14 w-14 inline-flex items-center"
              >
                <svg
                  width="24"
                  height="24"
